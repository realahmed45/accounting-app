...
const QuickStatsWidget = ({ expenses = [], weekDates }) => {
  ...
  return (
    <div className="glass-card !bg-slate-900/40 p-6 mb-6 overflow-hidden relative group">
      {/* Dynamic Background Glow */}
      <div className="absolute -top-24 -left-24 w-64 h-64 bg-indigo-500/10 rounded-full blur-[100px] group-hover:bg-indigo-500/20 transition-all duration-700"></div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="glass-card !bg-white/5 border-white/5 p-5 hover:border-blue-500/50 transition-all duration-500 group/stat">
        ...
        {/* Largest Expense */}
        <div className="glass-card !bg-white/5 border-white/5 p-5 hover:border-amber-500/50 transition-all duration-500 group/stat">
          <div className="flex items-center justify-between mb-4">
        ...
        {/* Most Used Category */}
        <div className="glass-card !bg-white/5 border-white/5 p-5 hover:border-purple-500/50 transition-all duration-500 group/stat">
          <div className="flex items-center justify-between mb-4">
