    ...
    <div className="space-y-10 animate-fadeIn">
      ...
      <div className="relative z-10 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
        <div>
          ...
          <p className="text-[10px] text-slate-400 font-black uppercase tracking-[0.4em] ml-16">
            Subscription & Usage Orchestration
          </p>
        </div>
        <button
          onClick={() => navigate("/plans")}
          className="group flex items-center gap-4 px-8 py-4 bg-white/5 hover:bg-white/10 border border-white/10 text-white rounded-2xl font-black text-[10px] uppercase tracking-[0.3em] transition-all hover:scale-[1.05] active:scale-[0.95] shadow-sm"
        >
      ...
      <div className="relative z-10 glass-card p-10 overflow-hidden group shadow-lg border-white/5">
          ...
          <div className="flex-1 space-y-6">
            <div className="space-y-2">
              ...
              <h3 className="text-5xl font-black text-white capitalize tracking-tighter italic">
                {subscription.currentPlan} <span className="text-indigo-400/50">Core</span>
              </h3>
            </div>
      ...
      {usage && (
        <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            ...
            return (
              <div key={idx} className="glass-card p-6 group hover:translate-y-[-4px] transition-all duration-500 shadow-sm border-white/5">
      ...
      <div className="relative z-10 glass-card p-10 pb-12 shadow-sm border-white/5">
          ...
          {subscription.features &&
            Object.entries(subscription.features).map(([feature, enabled], idx) => (
              ...
              >
                ...
                <div>
                  <p className={`text-[10px] font-black uppercase tracking-[0.2em] transition-colors ${enabled ? "text-white" : "text-slate-400"}`}>
