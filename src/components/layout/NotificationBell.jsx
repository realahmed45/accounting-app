  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <button
        ...
        className="relative flex items-center gap-2 px-3 sm:px-4 py-2 sm:py-2.5 bg-white hover:bg-slate-50 text-slate-700 transition-all duration-200 font-semibold border border-slate-200 rounded-xl shadow-sm hover:shadow"
      >
