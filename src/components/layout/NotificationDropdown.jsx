...
const NotificationDropdown = ({ onClose, onOpenCenter }) => {
  ...
  if (!notifications) {
    return (
      <div className="absolute right-0 mt-2 w-[calc(100vw-1rem)] sm:w-96 max-w-[calc(100vw-1rem)] bg-white rounded-xl shadow-2xl border border-slate-200 z-50 overflow-hidden">
