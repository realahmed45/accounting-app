...
const ToastNotification = ({ onOpenCenter }) => {
  ...
  const TOAST_DURATION_SECONDS = 50;
  ...
  return (
    <div
      className="fixed top-[max(1rem,env(safe-area-inset-top))] left-2 right-2 sm:left-auto sm:right-4 sm:top-20 z-50 space-y-3"
