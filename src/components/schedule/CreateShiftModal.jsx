      ...
      <div className="bg-white w-full max-w-lg rounded-[3rem] shadow-2xl overflow-hidden animate-in zoom-in duration-200">
        ...
        <form onSubmit={handleSubmit} className="p-4 sm:p-8 space-y-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="space-y-1">
              <label className="text-[10px] font-black uppercase text-gray-400 tracking-wider flex items-center gap-1.5">
                <UserPlus className="w-3 h-3" /> Assignment
              </label>
              <select
                className="w-full bg-gray-50 border-2 border-transparent rounded-2xl px-5 py-4 text-sm font-bold focus:bg-white focus:border-indigo-500 transition-all"
          ...
          {!formData.isAdHoc ? (
            <div className="space-y-1">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                ...
                {shiftTypes.length === 0 && (
                  <p className="col-span-2 text-[10px] text-gray-400 font-bold p-4 bg-gray-50 rounded-2xl text-center italic">
                    No templates found. Use Ad-Hoc mode.
                  </p>
                )}
              </div>
            </div>
            ...
            <div className="space-y-4 animate-in slide-in-from-left-4">
              <div className="space-y-1">
                ...
                <input
                  type="text"
                  className="w-full bg-gray-50 border-2 border-transparent rounded-2xl px-5 py-4 text-sm font-bold"
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="space-y-1">
                  ...
                  <input
                    type="time"
                    className="w-full bg-gray-50 rounded-2xl px-5 py-4 text-sm font-bold"
          ...
          <div className="pt-4 flex gap-3">
            <button
              type="button"
              onClick={onClose}
              className="flex-1 py-4 bg-gray-100 text-gray-500 font-bold rounded-[1.5rem] hover:bg-gray-200 transition-all"
            >
              Cancel
            </button>
            <button
            ...
            >
              {submitting ? (
                ...
                <>
                  <Save className="w-5 h-5" /> Schedule Shift
                </>
              )}
            </button>
          </div>
